...
module.exports.can_add_on_suspend = function can_add_on_suspend(name){
  if (text_log == undefined){ return false }
...
module.exports.add_impl = function add_impl(text_log){
...
module.exports.is_change = function is_change(msg){
