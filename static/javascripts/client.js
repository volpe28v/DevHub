...
function decorate_msg(msg){
  ...
  deco_msg = deco_msg.replace(/[\(（](笑|爆|喜|嬉|楽|驚|泣|涙|悲|怒|厳|辛|苦|閃|汗|忙|急|輝)[\)）]/g, function(){ return '<span class="emo" style="font-size: 18px; font-weight: normal;">' + arguments[1] + '</span>'});
